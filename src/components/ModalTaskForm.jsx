...
const ModalTaskForm = () => {
    ...
    const { modalTaskForm, handleModalTask, showAlert, alert, submitTask, task } = useProjects();
    ...
    const handleSubmit = async e => {
        ...
        await submitTask({ id, name, description, dueDate, priority, project: params.id})
